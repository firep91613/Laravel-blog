...
@section('content')
    <div class="content__header">
        <h1 class="content__title">{{ $post->title }}</h1>
    </div>

    <div class="content__body">
        <form action="{{ route('admin.posts.update', $post) }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            @method('PUT')
            ...
            <div class="form__group">
                <label class="input-file">
                    ...
                    <input type="file" name="image" class="input-file__custom" data-old="{{ config('custom.symbolic_images_link') . $post->image }}">
            ...
            <div class="form__group">
                ...
                <select name="tag_id[]" id="tag_id" class="form__select form__select_tags" multiple="multiple">
                    @foreach ($tags as $tag)
